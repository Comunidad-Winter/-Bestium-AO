...
If charlist(UserCharIndex).priv > 0 Then
            ...
            frmMain.CP.Visible = True
            frmMain.CR.Visible = True
            frmMain.GMTORNEO.Visible = True
            frmMain.CASTLEGM.Visible = True
            frmMain.GMPANEL.Visible = True
            frmMain.INVISIBLE.Visible = True
         Else
            frmMain.GMSOS.Visible = False
            frmMain.CR.Visible = False
            frmMain.GMTORNEO.Visible = False
            frmMain.CASTLEGM.Visible = False
            frmMain.GMPANEL.Visible = False
            frmMain.INVISIBLE.Visible = False
            frmMain.CP.Visible = False
        End If
'*****************************************************************
...
'*****************************************************************
    ...
    AddtoRichTextBox frmMain.RecTxt, "Bienvenido " & UserName & " a Bestium AO", 128, 128, 0, True, False, False
End Sub
...
On Error Resume Next
    ...
    If App.PrevInstance Then
        Call MsgBox("BestiumAOAO ya esta corriendo! No es posible correr otra instancia del juego. Haga click en Aceptar para salir.", vbApplicationModal + vbInformation + vbOKOnly, "Error al ejecutar")
        End
    End If
...
Dim timers(1 To 2) As Integer
    ...
    ChDrive App.Path
    ChDir App.Path
Dim fuente As clsInstalarFont
Set fuente = New clsInstalarFont
 
fuente.FicheroTTF = "Tahoma.ttf"
fuente.PathTTF = App.Path & "\INIT\"
fuente.Instalar
...
lastTime = GetTickCount
    ...
    Call InitTileEngine(frmMain.hwnd, 120, 8, 32, 32, 13, 17, 9)
