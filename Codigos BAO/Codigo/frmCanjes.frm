...
End If
End If
If List1.Text = "Espada Flamenguer" Then
If MsgBox("¿Está seguro que desea canjear una Espada Flamenguer?", vbYesNo) = vbYes Then
Call SendData("CANJE07")
End If
End If
If List1.Text = "Espada Diabólica" Then
If MsgBox("¿Está seguro que desea canjear una Espada Diabólica?", vbYesNo) = vbYes Then
...
End If
Picture = LoadPicture(App.Path & "\Graficos\Canjes.jpg")
...
List1.AddItem "Espada Flamenguer"
List1.AddItem "Espada Diabólica"
