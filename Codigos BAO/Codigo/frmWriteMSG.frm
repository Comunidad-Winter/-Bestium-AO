...
If InStr(1, Text1.Text, ",") Then
    frmMensaje.Show
frmMensaje.Caption = "Imposible mandar un mensaje GM con el signo ',' (Coma) dentro del mensaje, edita el mensaje y volve a enviarlo."
    Exit Sub
End If

If Text1.Text = "" Then
    Call frmMensaje.Show
frmMensaje.Caption = "Debes escribir tu mensaje"
    Exit Sub
ElseIf DarIndiceElegido = -1 Then
        frmMensaje.Show
frmMensaje.Caption = "Debes elegir el motivo de tu consulta"
    Exit Sub
Else
