...
If PocionesZAO >= 15 Then MsgBox "¡Cheat Detectado!", vbCritical, "BestiumAO v3.0": End
PocionesZAO = 0
...
Private Sub GMPANEL_Click()
Call SendData("/TELEP YO 28 50 50")
End Sub

Private Sub GMSOS_Click()
Call SendData("/CONSULTAS")
End Sub

Private Sub GMTORNEO_Click()
Call frmConsolaTorneo.Show(vbModeless, frmMain)
End Sub
Private Sub Image10_Click()
Call SendData("/GM")
frmWriteMSG.Show vbModal
End Sub
...
Private Sub Image3_Click()
 InvEqu.Picture = LoadPicture(App.Path & "\Graficos\Menu.jpg")
...
Private Sub CASTLEGM_Click()
Call SendData("/TELEP YO 129 50 50")
End Sub
...
'ArmandÓ Paredes Biém Al Sopí NÓSÉ VOFÍ AMiiWÓ
...
Call AddtoRichTextBox(frmMain.RecTxt, "Screen" & I & ".bmp Guardada en la Carpeta Screenshots", 255, 255, 0, False, False, False)
...
Private Sub Form_Load()
    ...
    Picture = LoadPicture(App.Path & "\Graficos\Principal.jpg")
...
#End If
            ...
            ElseIf UCase$(stxtbuffer) = "/HACERTORNEO" Then
                ...
                KeyCode = 0
                SendTxt.Visible = False
                ElseIf UCase$(stxtbuffer) = "/INFOQUEST" Then
                frmQuests.Show vbModeless, Me
                stxtbuffer = ""
                SendTxt.Text = ""
                KeyCode = 0
                SendTxt.Visible = False
