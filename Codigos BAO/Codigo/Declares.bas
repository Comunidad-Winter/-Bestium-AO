...
Public MinEleccion As Integer, MaxEleccion As Integer, Actual As Integer
...
Public Const MIIP As String = "25.125.145.123"
...
'[KEVIN]
Public Const MAX_BANCOINVENTORY_SLOTS = 45
