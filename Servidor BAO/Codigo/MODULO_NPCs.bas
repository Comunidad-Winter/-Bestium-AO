...
If Castillo = 1 Then
   ...
   Call SendData(ToAll, 0, 0, "|| El Clan " & (Guilds(UserList(userindex).GuildIndex).GuildName) & " Ha logrado conquistar el Castillo NORTE" & FONTTYPE_GUILD)
...
ElseIf Castillo = 2 Then
   ...
   Call SendData(ToAll, 0, 0, "|| El Clan " & (Guilds(UserList(userindex).GuildIndex).GuildName) & " Ha logrado conquistar el Castillo SUR" & FONTTYPE_GUILD)
...
ElseIf Castillo = 3 Then
   ...
   Call SendData(ToAll, 0, 0, "|| El Clan " & (Guilds(UserList(userindex).GuildIndex).GuildName) & " Ha logrado conquistar el Castillo ESTE" & FONTTYPE_GUILD)
...
ElseIf Castillo = 4 Then
   ...
   Call SendData(ToAll, 0, 0, "|| El Clan " & (Guilds(UserList(userindex).GuildIndex).GuildName) & " Ha logrado conquistar el Castillo OESTE" & FONTTYPE_GUILD)
